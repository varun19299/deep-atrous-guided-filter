...
class Unet(nn.Module):
    def __init__(self, args: "tupperware"):
        ...
        self.layer0 = nn.Sequential(
            nn.Conv2d(
                3, 128, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False
            ),
            normaliser(128),
            nn.ReLU(inplace=True),
        ...
        self.conv_original_size0 = convrelu(3, 128, 3, 1, normaliser=normaliser)
        ...
        self.get_image = nn.Sequential(nn.Conv2d(128, 3, 1), nn.Tanh())
